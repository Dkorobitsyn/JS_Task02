...
alert ("Введите два числа и оператор");
var a = +prompt ("Введите значение первого числа \n a = ");
var b = +prompt ("Введите значение второго числа \n b = ");
do {
...
alert ("Введите число и степень, в котору надо возвести число");
var a = +prompt ("Введите значение числа \n val = ");
var b = +prompt ("Введите значение стерени \n pow = ");
var result = power(a, b);
alert (`Результат возведения числа ${a} в степень ${b} равно ${result}`);

alert ("Конец прораммы");
